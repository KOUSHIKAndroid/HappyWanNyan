...
public class LoginFragmentViewPager extends FragmentStatePagerAdapter {
    LinkedList<Fragment> listItems;
    //String[] planets;


    public LoginFragmentViewPager(Context context, FragmentManager fm, LinkedList<Fragment> list) {
        super(fm);
        listItems = list;
