...
public class Advanced_Search_Fragment extends Fragment implements AppLocationProvider.AddressListener {
    ...
    public Advanced_Search_Fragment() {
        // Required empty public constructor
    }

    public static Advanced_Search_Fragment newInstance(String param1, String param2) {
        Advanced_Search_Fragment fragment = new Advanced_Search_Fragment();
                ...
                if (!TXT_Loction.getText().toString().trim().equals("")) {
                    ...
                    ((BaseActivity) getActivity()).getLocation(new Events() {
                        ...
                        public void UpdateLocation(Location location) {
                            ...
                            new AppLocationProvider().OnGetAddress(getActivity(), location, Advanced_Search_Fragment.this);
                        }
                    });
                }
...
//                    ArrayPetService.get(0).setTick_value(true);
                    ...
                    adapter_petlist = new Adapter_Petlist_Dialog(Advanced_Search_Fragment.this, getActivity(), ArrayPetService);
