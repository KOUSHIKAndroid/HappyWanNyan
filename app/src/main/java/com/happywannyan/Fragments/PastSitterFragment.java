...
public class PastSitterFragment extends Fragment {
    ...
    public static PastSitterFragment newInstance(String param1, String param2) {
        PastSitterFragment fragment = new PastSitterFragment();
